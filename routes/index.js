...
router.get("/", async function (req, res) {
  try {
    ...
    var message =
      "Error rendering landing page properly, please attend to this as soon as possible and deploy, thank you!";
...
router.post("/sendmail", function (req, res) {
  ...
  transporter.sendMail(HelperOptions, (error, info) => {
    ...
    try {
      HelperOptions = {
        from: '"' + "CerviTech" + '" <' + process.env.GMAIL_USER + ">",
        to: email,
        subject: "Thank you for contacting us!",
        html: `<h1>Thank you for contacting us!</h1>
		 <p>Dear ${name},</p>
		 <p>Thank you for contacting us! We appreciate your interest in our product, and we're thrilled to hear from you.</p>
		 <p>Our team will be reviewing your message shortly and will get back to you as soon as possible. We strive to respond to all inquiries within [timeframe], so please be sure to check your inbox for our response.</p>
		 <p>In the meantime, please feel free to learn more about our product by visiting our <a href="https://cervitech.com.ng">website</a>. You can also follow us on [insert social media platform] for the latest updates and news.</p>
		 <p>Thank you again for reaching out to us. We look forward to connecting with you soon!</p>
		 <p>Best regards,</p>
		 <p>CerviTech Team</p>`,
      };
